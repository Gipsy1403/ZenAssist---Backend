...
import ClaimComponent from '@/components/Claim.jsx';

export default function Inbox({ inboxId, onSelectClaim, selectedClaimId, claims, loading, onTagClick, onAutoTag}) {
