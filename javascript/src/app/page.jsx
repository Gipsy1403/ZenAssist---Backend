...
export default function Home() {
	...
	const handleAutoTag = async (claim) => {

		const res = await fetch(`/api/claims/${claim.id}/auto-tag`, {
			method: "POST",
		});
...
// 			// refresh list
// 			const updated = await fetchClaims(
// 				selectedInboxId === 'untagged' ? 'untagged' : selectedInboxId
// 			);
